...
def _label(column: str) -> str:
    return {"fiscal_year_label": "fiscal years", "class_label": "customer classes", "year": "years",
            "period": "periods", "utility": "utilities",
            "year_label": "years"}.get(column, column.replace("_", " "))
